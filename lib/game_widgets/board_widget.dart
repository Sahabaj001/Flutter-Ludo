...
import 'package:basic/game_internals/constants.dart';
import 'package:basic/game_internals/ludo_provider.dart';
import 'package:basic/game_widgets/pawn_widget.dart';
import 'package:provider/provider.dart';
import 'package:basic/game_internals/ludo_player.dart';
...
class BoardWidget extends StatelessWidget {
  ...
  List<Widget> winners(BuildContext context, List<LudoPlayerType> winners) => List.generate(
        winners.length,
        (index) {
          Widget crownImage = Image.asset("assets/games/ludo/crown/1st.jpg");
          ...
          if (index == 0) {
            crownImage = Image.asset("assets/images/crown/1st.jpg", fit: BoxFit.cover);
          } else if (index == 1) {
            crownImage = Image.asset("assets/images/crown/2nd.jpg", fit: BoxFit.cover);
          } else if (index == 2) {
            crownImage = Image.asset("assets/images/crown/3rd.jpg", fit: BoxFit.cover);
          } else {
            return Container();
          }
